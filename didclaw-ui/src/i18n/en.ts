...
export default {
  ...
  company: {
    ...
    refreshList: "Refresh",
    openAllRolePanels: "Open role panels for all non-main agents",
    openPanelHint:
      "Opens a chat column on the right; shares one Gateway WebSocket, isolated by sessionKey.",
    openRolePanel: "Open role panel",
    desktopOnly: "This feature requires the DidClaw desktop app.",
    saveNeedsDesktopOrGateway:
      "Saving agents.list requires a connected local Gateway, or the DidClaw desktop app to write openclaw.json.",
    gatewayConfigHashStale:
      "The config changed on disk before save (hash mismatch). Click Refresh, then save again.",
    gatewayConfigInvalidPatch: "Gateway rejected the patch: {message}",
    gatewayConfigMissingHash:
      "Gateway did not return a usable config snapshot hash. Try Refresh or check the gateway version.",
    gatewayConfigRequestFailed: "Gateway config request failed: {message}",
    gatewayConfigRateLimited: "Gateway config writes are rate-limited; try again in about {seconds}s.",
    afterWriteAgentsViaGateway:
      "agents.list was merged via the gateway. The gateway may restart and briefly disconnect; restart it manually if hot reload does not apply.",
    afterWriteAgentsLocalFallbackLead:
      "The gateway did not apply this change; merged into local openclaw.json instead (desktop backup rules applied).",
    ...
    floatingOpenedColumns: "Open role columns",
    floatingNoColumns: "No side columns yet. Open one below or use the full hub.",
    floatingConfiguredAgents: "agents in openclaw.json",
    floatingLoading: "Loading…",
    floatingEmptyAgents: "No agents.list (or config missing).",
    floatingLoadFailed: "Load failed",
    floatingNoApi: "Desktop API not available in this environment.",
    floatingClose: "Close",
    floatingOpenColumn: "Open column",
    floatingOpenHub: "Open full hub…",
  ...
  generalSettings: {
    ...
    toolsProfileCodingDesc: "File I/O, runtime, sessions, image",
    toolsProfileMessaging: "Messaging (messaging)",
    toolsProfileMessagingDesc: "Messaging and session management only",
    toolsProfileMinimal: "Minimal (minimal)",
    toolsProfileMinimalDesc: "session_status only",
    toolsProfileSaving: "Saving…",
    toolsProfileSaved: "Saved",
  },
  usageStats: {
    title: "Usage Stats",
    menuBtn: "Usage Stats",
