...
In Markdown reports use placeholders like `[Attach: defect photo]`; when exporting to Word/PPT or uploading to a report system, the user attaches the actual files in the right section.
...
## Strict customers and multi-customer formats

For **strict customer** handling (Foxconn, OEMs, tier-1, mandatory evidence, sign-off) and **multi-customer format** logic (formats/, user-provided template, mapping rule), see SKILL.md sections "Strict / high-requirement customers" and "Customer-specific / multi-customer formats". This reference focuses on methodology and tools; operational workflow and prompts live in SKILL.md.

---

*This reference supplements SKILL.md; skill execution follows the template and workflow in SKILL.md.*
