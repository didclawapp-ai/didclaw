...
## Format discovery (user says → format file)

| User expression | Format file |
|-----------------|-------------|
| automotive, OEM, 汽车主机厂, 主机厂 | `automotive-oem.md` |
| (other customers) | Create `formats/<name>.md` per "Adding a new customer format" |
