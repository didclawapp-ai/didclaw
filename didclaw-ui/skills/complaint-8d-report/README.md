...
Generates or completes **8D reports** (Eight Disciplines) from complaint data, with a standard template and D1–D8 fill-in guidance. Output: Markdown/Word or **PPT (.pptx)** for presentation.
...
| `formats/automotive-oem.md` | Automotive OEM customer-specific format |
